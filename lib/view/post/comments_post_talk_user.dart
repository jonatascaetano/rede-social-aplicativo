...
class CommentPostTalkUser extends StatefulWidget {
  PostTalkMini post;
  bool screenUser;
  bool screenProfile;
  BuildContext contextPage;
  CommentPostTalkUser({required this.post, required this.screenUser, required this.screenProfile, required this.contextPage, Key? key}) : super(key: key);

  @override
  _CommentPostTalkUserState createState() => _CommentPostTalkUserState();
}

class _CommentPostTalkUserState extends State<CommentPostTalkUser> {
                                                ...
                                                Align(
                                                  ...
                                                  child: GestureDetector(
                                                    ...
                                                    child: ConvertLikeNames.returnLikes(
                                                      liked: comment.postTalkMini.liked,
                                                      likeQuantity: comment.postTalkMini.likeQuantity,
                                                      like: comment.postTalkMini.like,
                                                      context: context,
                                                    ),
                                                  ),
                                                ),
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Center(
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  comment.postTalkMini.likeQuantity.toString() + " ",
                                                                  style: TextStyle(
                                                                    fontSize: theme.sizeText,
                                                                    letterSpacing: theme.letterSpacingTitle,
                                                                    color: comment.postTalkMini.liked ? theme.emphasis : theme.subtitle,
                                                                    fontWeight: FontWeight.normal,
                                                                  ),
                                                                ),
                                                                Icon(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Center(
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  comment.postTalkMini.commentQuantity.toString() + " ",
                                                                  style: TextStyle(
                                                                    fontSize: theme.sizeText,
                                                                    letterSpacing: theme.letterSpacingTitle,
                                                                    color: theme.subtitle,

...
// class Entity_test extends StatefulWidget {
//   EntityMini entityMini;
//   bool datasheetIsOpen;
//   Entity_test({required this.entityMini, required this.datasheetIsOpen, Key? key}) : super(key: key);

//   @override
//   _Entity_testState createState() => _Entity_testState();
// }

// // ignore: camel_case_types
// class _Entity_testState extends State<Entity_test> {
...
//                                             Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateReviewEntity(review: entity.entitySaveMini!.review!, contextEntityPage: context,)));
//                                           } else if (entity.entitySaveMini != null) {
//                                             Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateReviewEntity(review: '', contextEntityPage: context,)));
//                                           }
//                                         },
